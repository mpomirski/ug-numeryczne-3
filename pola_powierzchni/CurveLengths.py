...
def main() -> None:
    ...
    print(f"Rectangle method delta:\t{abs(np.pi - (results[0] / 2)):.15f}")
    print(f"Trapezoid method delta:\t{abs(np.pi - (results[1] / 2)):.15f}")
    print(f"Simpson method delta:\t{abs(np.pi - (results[2] / 2)):.15f}")
    print(f"CSI method delta:\t{abs(np.pi - (results[3] / 2)):.15f}")
